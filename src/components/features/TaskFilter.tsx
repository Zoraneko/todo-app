...
import { CalendarClock, ChevronDown, ChevronUp, ClockPlus, Search } from "lucide-react"
    ...
    return (
        !isCollapsed ? (
            <div className="flex flex-col md:flex-row gap-4 w-full bg-slate-50/50 p-4 rounded-xl border border-slate-200">
                <div className="flex flex-col gap-2 flex-1 sm:flex-none  justify-center items-center">
                    <Button variant="outline" className="w-10 h-10 flex" onClick={() => setIsCollapsed(!isCollapsed)}>
                        <ChevronUp />
                    </Button>
                </div>
            ...
            <div className="flex w-full md:w-auto">
                <Button variant="outline" className="h-10 flex flex-row gap-2 w-full" onClick={() => setIsCollapsed(!isCollapsed)}>
                    <ChevronDown />
                    Search & Filters
                </Button>
            </div>
